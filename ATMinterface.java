...
class BankAccount{
        ...
        public void register(){
                ...
                System.out.println("Registration Sucessful.Plaese log in to your bank account ");
         ...
         public void transfer()
        {
                ...
                try
                {
                        ...
                        if(amount <= 10000)
                        {
                                transactions++;
                                balance -= amount;
                                System.out.println("\n trsnsfer sucessfull to "+receipent);
                                String str = amount +"Rs trsnsfer to " +receipent+"\n";
                                transactionHistory = transactionHistory.concat(str);
        ...
        public void checkBalance(){
                System.out.println("\n your balnce is : "+balance+"Rs");
        }
        
        public void transHistory(){
                if(transactions == 0){
                        System.out.println("No transcations happend");
                }else{
                   System.out.println("\n"+transactionHistory);     
                }
        }
